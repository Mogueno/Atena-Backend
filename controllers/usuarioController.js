...
exports.getUser = function (req, resp, userID) {
  db.executeSql("SELECT TB_USER.USER_INT_ID, TB_USER.USER_STR_NOME, TB_USER.USER_INT_IDADE, TB_USER.USER_STR_SEXO, TB_USER.USER_STR_EMAIL, TB_USER.USER_STR_FACEBOOKLOGIN, TB_USER.USER_STR_GOOGLELOGIN, TB_USER_CUR.CUR_INT_ID, TB_USER_MAT.MAT_INT_ID, TB_USER_FAC.FAC_INT_ID FROM TB_USER JOIN TB_USER_CUR ON TB_USER.USER_INT_ID = TB_USER_CUR.USER_INT_ID JOIN TB_USER_FAC ON TB_USER.USER_INT_ID = TB_USER_FAC.USER_INT_ID JOIN TB_USER_MAT ON TB_USER.USER_INT_ID = TB_USER_MAT.USER_INT_ID WHERE TB_USER.USER_INT_ID =" + userID, function (
    data,
    err
  ) {
    if (err) {
